        ...
        <div className="mx-auto max-w-[900px] space-y-12 px-5 md:px-8">
          ...
          <FadeUp delay={0.6}>
            <div className="prose prose-invert max-w-none">
              ...
              <p className="mt-4 leading-relaxed text-ink-dim">
                To exercise these rights, please contact us at hello@scaleshark.com or via WhatsApp at +33 6 50 98 69 94.
              </p>
            </div>
          </FadeUp>
          ...
          <FadeUp delay={1.5}>
            <div className="prose prose-invert max-w-none">
              ...
              <p className="mt-4 leading-relaxed text-ink-dim">
                Email:{" "}
                <a href="mailto:hello@scaleshark.com" className="text-violet hover:underline">
